...
import (
	...
	pb "EcoTrack/community/genproto/protos" // Protokol paketini Go tiliga ko'chirish
...
func (s *Server) CreateGroup(req *pb.CreateGroupRequest) (*pb.GroupResponse, error) {
	...
	return &pb.GroupResponse{Id: int32(id), Name: req.Name, Description: req.Description, CreatedBy: req.CreatedBy}, nil
}
...
func (s *Server) GetGroup(req *pb.GetGroupRequest) (*pb.GroupResponse, error) {
	...
	return &pb.GroupResponse{Id: req.Id, Name: name, Description: description, CreatedBy: createdBy}, nil
}
...
func (s *Server) UpdateGroup(req *pb.UpdateGroupRequest) (*pb.GroupResponse, error) {
	...
	return &pb.GroupResponse{Id: req.Id, Name: req.Name, Description: req.Description}, nil
}
...
func (s *Server) DeleteGroup(req *pb.DeleteGroupRequest) (*pb.DeleteGroupResponse, error) {
	...
	if err != nil {
		return &pb.DeleteGroupResponse{Success: false, Message: err.Error()}, nil
	}
	return &pb.DeleteGroupResponse{Success: true, Message: "Group deleted successfully"}, nil
}
...
func (s *Server) ListGroups(req *pb.ListGroupsRequest) (*pb.ListGroupsResponse, error) {
	...
	for rows.Next() {
		...
		groups = append(groups, &pb.GroupResponse{Id: id, Name: name, Description: description, CreatedBy: createdBy})
	}
...
func (s *Server) JoinGroup(req *pb.JoinGroupRequest) (*pb.GroupMemberResponse, error) {
	...
	return &pb.GroupMemberResponse{GroupId: req.GroupId, UserId: req.UserId, Role: "member"}, nil
}
...
func (s *Server) LeaveGroup(req *pb.LeaveGroupRequest) (*pb.GroupMemberResponse, error) {
	...
	return &pb.GroupMemberResponse{GroupId: req.GroupId, UserId: req.UserId}, nil
}
...
func (s *Server) UpdateGroupMemberRole(req *pb.UpdateGroupMemberRoleRequest) (*pb.GroupMemberResponse, error) {
	...
	return &pb.GroupMemberResponse{GroupId: req.GroupId, UserId: req.UserId, Role: req.Role}, nil
}
...
func (s *Server) CreatePost(req *pb.CreatePostRequest) (*pb.PostResponse, error) {
	...
	return &pb.PostResponse{Id: int32(id), GroupId: req.GroupId, UserId: req.UserId, Content: req.Content}, nil
}
...
func (s *Server) GetPost(req *pb.GetPostRequest) (*pb.PostResponse, error) {
	...
	return &pb.PostResponse{Id: req.Id, GroupId: groupId, UserId: userId, Content: content}, nil
}
...
func (s *Server) UpdatePost(req *pb.UpdatePostRequest) (*pb.PostResponse, error) {
	...
	return &pb.PostResponse{Id: req.Id, GroupId: req.GroupId, UserId: req.UserId, Content: req.Content}, nil
}
...
func (s *Server) DeletePost(req *pb.DeletePostRequest) (*pb.DeletePostResponse, error) {
	...
	if err != nil {
		return &pb.DeletePostResponse{Success: false, Message: err.Error()}, nil
	}
	return &pb.DeletePostResponse{Success: true, Message: "Post deleted successfully"}, nil
}
...
func (s *Server) ListGroupPosts(req *pb.ListGroupPostsRequest) (*pb.ListPostsResponse, error) {
	...
	for rows.Next() {
		...
		posts = append(posts, &pb.PostResponse{Id: id, GroupId: groupId, UserId: userId, Content: content, CreatedAt: createdAt})
	}
...
func (s *Server) CreateComment(req *pb.CreateCommentRequest) (*pb.CommentResponse, error) {
	...
	return &pb.CommentResponse{Id: int32(id), PostId: req.PostId, UserId: req.UserId, Content: req.Content}, nil
}
...
func (s *Server) GetPostComments(req *pb.GetPostCommentsRequest) (*pb.ListCommentsResponse, error) {
	...
	for rows.Next() {
		...
		comments = append(comments, &pb.CommentResponse{Id: id, PostId: postId, UserId: userId, Content: content, CreatedAt: createdAt})
	}
