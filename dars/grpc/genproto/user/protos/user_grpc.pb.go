...
type UserServiceClient interface {
	CreateUser(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*User, error)
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserReq, opts ...grpc.CallOption) (*User, error) {
...
type UserServiceServer interface {
	CreateUser(context.Context, *UserReq) (*User, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *UserReq) (*User, error) {
